...
import { MapIcon, Navigation, Sparkles, Cpu, Globe } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-travel flex flex-col relative">
        ...
        <div className="max-w-7xl mx-auto h-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 h-full">
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              {/* AI-Powered Badge */}
              <div className="bg-panel rounded-lg p-4 shadow-soft border border-primary/20 map-texture relative overflow-hidden">
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-2">
                    <Sparkles className="w-4 h-4 text-primary animate-safety-pulse" />
              ...
              {/* Quick Tips */}
              <div className="bg-panel rounded-lg p-4 shadow-soft border border-border city-silhouette relative overflow-hidden">
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-2">
                    <Globe className="w-4 h-4 text-primary" />
                    <h3 className="text-sm font-semibold text-card-foreground">Global Coverage</h3>
                  </div>
                  <ul className="text-xs text-muted-foreground space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>India: All states, districts, towns & villages</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-caution mt-0.5">•</span>
                      <span>Click markers for AI safety details</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 min-h-[400px] lg:min-h-[600px]">
              {!hasSearched ? (
                <div className="h-full flex flex-col items-center justify-center bg-panel rounded-lg border border-border shadow-soft map-texture relative overflow-hidden">
                  <div className="relative z-10 flex flex-col items-center">
                    <div className="p-6 rounded-full bg-primary/10 mb-4 shadow-glow">
                    ...
                    <div className="flex items-center gap-2 mt-4 text-sm text-muted-foreground">
                      <Globe className="w-4 h-4 text-primary" />
                      <span>Global coverage with India focus</span>
                    </div>
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              {selectedSafetyData ? (
                ...
                <div className="bg-panel rounded-lg p-6 shadow-soft border border-border text-center map-texture relative overflow-hidden">
                  <div className="relative z-10">
      ...
      {/* Footer */}
      <footer className="bg-panel border-t border-border py-4 px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs">⚠️ Prototype with sample data</span>
          </div>
        </div>
      </footer>
    </div>
